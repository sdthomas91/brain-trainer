...
const { shuffleCards, flipCard, startTimer, checkForMatch, disableCards, unflipCards, resetGame, stopTimer, formatTime, resetBoard, playBgMusic, resetClick } = require('../script');
